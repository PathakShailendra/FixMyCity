  ...
  const handleSubmit = async (e) => {
    ...
    // }
      try {
        ...
        const response = await axios.post('https://fixmycity-backend.onrender.com/api/user/register/complaint', formDatanew, {
          headers: {
            "Content-Type": "multipart/form-data",
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <textarea
              ...
              value={formData.complaintDescription || des}
              onChange={handleInputChange}
                ...
                <>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="bg-green-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded transition duration-300"
                    >
                      Get Description
                    </button>
                  </div>
