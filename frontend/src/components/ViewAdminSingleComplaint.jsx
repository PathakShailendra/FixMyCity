...
const ViewAdminSingleComplaint = () => {
  ...
  const handleGenerateDescription = async () => {
    ...
    try {
      ...
      const imageResponse = await fetch(complaint.imageUrl);
      const imageBlob = await imageResponse.blob();

      // Create a File object from the blob
      const imageFile = new File([imageBlob], 'complaint-image.jpg', {
        type: imageBlob.type,
      });
      ...
      // Send POST request to generate description
...
{/*             onClick={handleUpdateDepartment} */}
        ...
        {generatedDescription && (
          <div className="mb-6">
            <h4 className="font-semibold mb-1">Generated Description</h4>
