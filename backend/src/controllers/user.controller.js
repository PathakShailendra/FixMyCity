...
import { generateCaptionFromImageBuffer } from "../utils/ai.service.js";
...
export const generateDescriptionFromImageController = async (req, res) => {
  try {
    const file = req.file;
    ...
    const description = await generateCaptionFromImageBuffer(imageBuffer);
